...
(2, 'hanako02', '1992-07-20', '090-2222-2222', 'hanako02@example.com', 0, '服が好きです。', 8000, '2025-10-31 01:45:42', '2025-11-04 08:38:09', '本人確認済み', NULL, 'hanako123', 'luna.png', 1, 0, 1, 1, 1, 1, 0, '佐藤', '花子', 'サトウ', 'ハナコ'),
...
INSERT INTO `m_product` (`id`, `name`, `purchasePrice`, `rentalPrice`, `size`, `color`, `for`, `upload`, `showing`, `draft`, `updateDate`, `purchaseFlg`, `rentalFlg`, `explanation`, `account_id`, `brand_id`, `category_id`, `cleanNotes`, `smokingFlg`, `returnAddress`) VALUES
(1, '地雷系フリルブラウス', 5800, 1200, 'M', 'ホワイト', 'レディース', '2025-09-28', '公開', 0, '2025-09-28 13:00:00', 1, 0, 'レースのついた甘めのブラウス。', 1, 2, 1, '手洗い推奨', 0, NULL),
(2, 'オーバーシャツ', 7200, 1500, 'L', 'ブルー', 'ユニセックス', '2025-09-15', '公開', 0, '2025-09-15 10:00:00', 1, 1, 'ゆったりとしたシルエット。', 2, 1, 2, 'ネット使用', 0, NULL),
(3, 'モードチェーンネックレス', 3200, 800, 'Free', '', 'ユニセックス', '2025-08-01', '公開', 0, '2025-08-01 15:00:00', 1, 0, 'シンプルで存在感あるデザイン。', 3, 3, 3, NULL, 0, NULL),
(4, 'くすみピンクカーディガン', 6400, 1300, 'M', 'ピンク', 'レディース', '2025-07-25', '非公開', 0, '2025-07-25 11:00:00', 1, 0, '淡いピンクで柔らかい印象に。', 4, 2, 1, NULL, 0, NULL),
(5, 'グランジダメージデニム', 8900, 1600, 'L', 'ブルー', 'ユニセックス', '2025-07-18', '公開', 0, '2025-07-18 09:30:00', 1, 1, '古着風のユーズド加工。', 5, 1, 1, '洗濯機OK', 0, NULL),
(6, '黒地レーススカート', 7800, 1500, 'M', 'ブラック', 'レディース', '2025-07-02', '公開', 0, '2025-07-02 12:00:00', 1, 0, '地雷系にぴったりのレーススカート。', 1, 2, 1, 'ドライ推奨', 0, NULL),
(7, 'ダークアシメトリートップス', 6100, 1200, 'M', 'グレー', 'レディース', '2025-06-25', '公開', 0, '2025-06-25 14:10:00', 1, 0, '片側ショルダーのモード系トップス。', 3, 4, 2, NULL, 0, NULL),
(8, 'オーバーサイズパーカー', 7800, 1700, 'XL', 'ブラック', 'ユニセックス', '2025-06-10', '公開', 0, '2025-06-10 09:00:00', 1, 1, 'ストリート感のあるゆったりパーカー。', 2, 5, 2, '乾燥機不可', 0, NULL),
(9, 'ゆるだぼ古着風Tシャツ', 4200, 900, 'L', 'ブラウン', 'ユニセックス', '2025-05-30', '非公開', 0, '2025-05-30 13:00:00', 1, 0, '味のあるくすみカラー。', 6, 3, 2, '手洗い可', 0, NULL),
(10, '地雷系リボンカチューシャ', 2800, 700, 'Free', 'ブラック', 'レディース', '2025-05-15', '公開', 0, '2025-05-15 16:30:00', 1, 0, 'ふんわりリボンがポイント。', 7, 2, 3, NULL, 0, NULL),
(11, 'チェック柄プリーツスカート', 6800, 1500, 'S', 'グレー', 'レディース', '2025-05-02', '公開', 0, '2025-05-02 09:45:00', 1, 0, 'スクール風で地雷にも量産にも合う。', 8, 1, 1, NULL, 0, NULL),
(12, 'パンクスタッズベルト', 3500, 800, 'Free', 'ブラック', 'ユニセックス', '2025-04-18', '公開', 0, '2025-04-18 11:00:00', 1, 0, 'シルバースタッズが印象的。', 9, 4, 3, NULL, 0, NULL),
(13, 'スモーキーグレーニット', 7200, 1400, 'M', 'グレー', 'ユニセックス', '2025-04-05', '非公開', 0, '2025-04-05 10:00:00', 1, 1, 'くすみカラーの柔らかいニット。', 10, 2, 2, 'ネット洗い', 0, NULL),
(14, 'レトロ刺繍ブラウス', 6500, 1300, 'M', 'ホワイト', 'レディース', '2025-03-25', '公開', 0, '2025-03-25 13:00:00', 1, 0, 'アンティーク調の刺繍デザイン。', 11, 3, 1, NULL, 0, NULL),
(15, 'クラッシュデニムパンツ', 8400, 1600, 'L', 'ブルー', 'ユニセックス', '2025-03-10', '公開', 0, '2025-03-10 14:30:00', 1, 1, 'ラフなクラッシュ加工入り。', 12, 1, 1, '裏返し洗い', 0, NULL),
(16, '黒蝶ネックレス', 3900, 850, 'Free', 'ブラック', 'レディース', '2025-02-28', '公開', 0, '2025-02-28 12:10:00', 1, 0, '地雷系の定番黒蝶モチーフ。', 13, 4, 3, NULL, 0, NULL),
(17, 'ゆめかわハートイヤリング', 3100, 750, 'Free', 'ピンク', 'レディース', '2025-02-20', '非公開', 0, '2025-02-20 11:30:00', 1, 0, '量産型に人気のアクセ。', 14, 2, 3, NULL, 0, NULL),
(18, 'グラデーションスウェット', 7600, 1600, 'L', 'パープル', 'ユニセックス', '2025-02-05', '公開', 0, '2025-02-05 13:00:00', 1, 1, '淡いグラデが特徴のストリート風。', 15, 5, 2, NULL, 0, NULL),
(19, 'フェイクレザージャケット', 9500, 2000, 'M', 'ブラック', 'ユニセックス', '2025-01-28', '公開', 0, '2025-01-28 09:00:00', 1, 1, '韓国風のシンプルなレザージャケット。', 16, 1, 1, '乾燥機不可', 0, NULL),
(20, 'ダークフリルワンピース', 8800, 1700, 'M', 'ブラック', 'レディース', '2025-01-15', '公開', 0, '2025-01-15 12:00:00', 1, 0, 'ゴシック地雷系に人気のワンピース。', 17, 3, 1, 'ドライ推奨', 0, NULL),
(31, 'EWW', NULL, 2147483647, 'kawaii', 'ピンク', 'レディース', '2025-11-01', '公開', 0, '2025-11-01 22:01:12', 0, 1, 'ルーナ\n                    ', 1, 13, 1, 'nanora', 0, NULL),
(32, 'Luna', NULL, 2147483647, 'kawaii', 'ピンク', 'レディース', '2025-11-01', '公開', 0, '2025-11-01 22:03:49', 0, 1, 'nanora', 1, 13, 1, 'nanora', 0, NULL),
(33, 'Luna', 1323232323, 1222232323, 'kawaii', 'ピンク', 'レディース', '2025-11-01', '公開', 0, '2025-11-01 22:45:38', 1, 1, 'nnnaaaaaaaa', 1, 13, 2, 'nanora', 0, NULL),
(34, 'rrrrr', NULL, 1111111, '1111', 'パープル', 'レディース', '2025-11-01', '公開', 0, '2025-11-01 22:51:08', 0, 1, '            \n                    1111', 1, 5, 2, '11111', 0, NULL),
(36, 'Luna', 11111111, NULL, '1111', 'ブラック', 'ユニセックス', '2025-11-03', '公開', 0, '2025-11-03 16:02:43', 1, 0, '            \n                  11  ', 1, 9, 2, '', 0, NULL),
(37, 'Luna', NULL, NULL, 'M', 'ブルー', 'ユニセックス', '2025-11-04', '公開', 0, '2025-11-04 12:16:01', 0, 1, '            \n                 kawaii   ', 1, 5, 2, '', 0, NULL),
(38, 'EWW', NULL, 9989, 'S', 'ブラック', 'レディース', '2025-11-04', '公開', 0, '2025-11-04 20:22:06', 0, 1, '            \n                    ', 2, 9, 2, 'なし', 0, NULL),
(39, '服', 99999, NULL, 'L', 'ブラック', 'ユニセックス', '2025-11-04', '公開', 0, '2025-11-04 21:12:46', 1, 0, '            \n                    ', 2, 11, 2, 'なし', 1, NULL),
(40, 'エンジェリックブルーパーカー', 6600, NULL, 'Sサイズ', 'ブルー', 'レディース', '2025-11-05', '公開', 0, '2025-11-05 09:42:07', 1, 0, 'ホワイトをベースに、やさしい水色を組み合わせた配色が印象的なフード付きジップパーカーです。フロントはジップ仕様で着脱がしやすく、両サイドにはポケットを備えています。身頃の両サイドにはクロスリボンがあしらわれ、動きに合わせて揺れるデザインがさりげないアクセントになります。フードには小さな耳の装飾がついており、全体に遊び心のある雰囲気をプラスしています。シルエットはオーバーサイズで、ゆったりとした着こなしが楽しめます。\n  ', 1, 13, 2, '特になし', 1, NULL);
...
--
-- 傾印資料表的資料 `m_productimg`
--

INSERT INTO `m_productimg` (`id`, `product_id`, `img`) VALUES
(1, 32, 'cloth000111.png'),
(2, 38, 'product_38_0_1762255326812.png'),
(61, 1, 'cloth.jpg'),
(62, 2, 'image39.png'),
(63, 3, 'Frame 318.png'),
(64, 4, 'Frame 319.png'),
(65, 5, 'image 43.png'),
(66, 39, 'product_39_0_1762258366188.png'),
(67, 40, 'product_40_0_1762303327643.png');
...
(34, 999.99, 0.00, 0.00, 0.00, '1111'),
(36, 111.00, 0.00, 0.00, 0.00, '1111'),
(37, 50.00, 50.00, 50.00, 50.00, 'M'),
(38, 11.00, 11.00, 11.00, 11.00, 'S'),
(39, 11.00, 11.00, 11.00, 11.00, 'L'),
(40, 80.00, 106.00, 56.00, 56.00, 'Sサイズ');
...
(11, 1, '                aaa', '2025-11-05 13:44:24', NULL),
(12, 1, '                aaa', '2025-11-05 13:51:23', NULL),
(13, 1, '                aaa', '2025-11-05 13:52:18', NULL),
(14, 1, '                aaa', '2025-11-05 13:52:26', NULL),
(15, 1, '                aaa', '2025-11-05 13:53:42', NULL),
(16, 1, '                aa', '2025-11-05 13:54:04', NULL);
...
--
-- 替換檢視表以便查看 `v_age_group_new_users`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `v_compare_1_week_ago_listing`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `v_compare_1_week_ago_new_users`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `v_monthly_active_users`
-- (請參考以下實際畫面)
--
...
--
-- 替換檢視表以便查看 `v_weekly_active_users`
-- (請參考以下實際畫面)
--
...
--
-- 檢視表結構 `v_compare_1_week_ago_listing`
--
...
--
-- 檢視表結構 `v_compare_1_week_ago_new_users`
--
...
--
-- 資料表索引 `m_adminaccount`
--
ALTER TABLE `m_adminaccount`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `m_admin_contents`
--
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_account`
--
ALTER TABLE `m_account`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_address`
--
ALTER TABLE `m_address`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_adminaccount`
--
ALTER TABLE `m_adminaccount`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_admin_contents`
--
ALTER TABLE `m_admin_contents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_brand`
--
ALTER TABLE `m_brand`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_category`
--
ALTER TABLE `m_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_cleansign`
--
ALTER TABLE `m_cleansign`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=713;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_product`
--
ALTER TABLE `m_product`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `m_productimg`
--
ALTER TABLE `m_productimg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_adminlogin`
--
ALTER TABLE `t_adminlogin`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_alert`
--
ALTER TABLE `t_alert`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_comments`
--
ALTER TABLE `t_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_connection`
--
ALTER TABLE `t_connection`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_creditcard`
--
ALTER TABLE `t_creditcard`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_evaluation`
--
ALTER TABLE `t_evaluation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_favorite`
--
ALTER TABLE `t_favorite`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_history`
--
ALTER TABLE `t_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_inquiry`
--
ALTER TABLE `t_inquiry`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_message`
--
ALTER TABLE `t_message`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_time`
--
ALTER TABLE `t_time`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_transaction`
--
ALTER TABLE `t_transaction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `t_transfer`
--
ALTER TABLE `t_transfer`
